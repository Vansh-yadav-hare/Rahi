...
export default function SearchPage() {
  ...
  return <div className="mx-auto max-w-6xl px-5 py-10 md:py-14">
    ...
    "Max 2 in the back",
    "Luggage space"
  ].map((f) => <li key={f} className="flex items-center gap-2.5">
        ...
        <div className="grid gap-4">
          {results.length ? results.map((ride) => <RideCard key={ride.id} ride={ride} />) : <div className="rounded-2xl border border-dashed border-border p-12 text-center">
