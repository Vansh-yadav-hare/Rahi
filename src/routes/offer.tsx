...
export const Route = createFileRoute("/offer")({
  head: () => ({
    meta: [
      { title: "Offer a Ride — Publish Your Empty Seats | RideSure" },
      {
        name: "description",
        content:
          "Driving intercity? Publish your route on RideSure, get matched with verified passengers and cover your fuel with next-day payouts.",
      },
      { property: "og:title", content: "Offer a Ride on RideSure" },
      {
        property: "og:description",
        content: "Publish your route, pick verified passengers, get paid the day after the trip.",
      },
...
const field =
  "flex items-center gap-2 rounded-xl border border-border bg-card px-3.5 py-3 focus-within:border-primary/60 focus-within:ring-2 focus-within:ring-ring/20 transition-smooth";
