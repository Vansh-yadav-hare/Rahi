...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "RideSure — Trust-First Ride Sharing & Verified Carpooling" },
      {
        name: "description",
        content:
          "Book verified carpool rides with ID-checked drivers, live tracking, SOS and an AI trust score on every seat. Women-only rides available.",
      },
      { property: "og:title", content: "RideSure — Trust-First Ride Sharing" },
      {
        property: "og:description",
        content:
          "Verified drivers, live trip tracking and AI trust scores. Share the ride, not the risk.",
      },
